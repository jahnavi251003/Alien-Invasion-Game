...
class Scoreboard():
	...
	def __init__(self, ai_settings, screen, stats):
		...
		self.font = pygame.font.Font('/Users/jahnavi/Desktop/python/alien_invasion/invasion.TTF', 30)
...
class Quit_State():
	def __init__(self, ai_settings, screen):
		...
		self.font = pygame.font.Font('/Users/jahnavi/Desktop/python/alien_invasion/invasion.TTF', 40)

		self.quit_statement(ai_settings)

	def quit_statement(self, ai_settings):
		quit_state = "'q' to quit"
		self.font = pygame.font.Font('/Users/jahnavi/Desktop/python/alien_invasion/invasion.TTF', 20)
